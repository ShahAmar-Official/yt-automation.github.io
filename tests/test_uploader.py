...
class TestBuildCredentials(unittest.TestCase):
    ...
    def test_raises_when_google_auth_not_installed(self):
        ...
        with patch.dict(sys.modules, {
            ...
            # Re-import to force the ImportError path — just verify the
            # function is callable and handles missing deps gracefully.
            # (Full ImportError simulation is environment-dependent.)
    ...
    def test_scopes_cleared_after_refresh(self):
        ...
        # Simulate the refresh populating scopes on the object
    ...
    def test_raises_when_refresh_fails(self):
        ...
        self.assertIn("YOUTUBE_TOKEN", str(ctx.exception))  # re-auth hint present
